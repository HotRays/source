...
VERSION_PRODUCTBRAND:=$(call qstrip_escape,$(CONFIG_VERSION_PRODUCTBRAND))
VERSION_PRODUCTBRAND:=$(if $(VERSION_PRODUCTBRAND),$(VERSION_PRODUCTBRAND),Bleeding Edge)
